...
const ICONS = {
  ...
  cutFlowers: (
    <>
      <path d="M12 22V12" />
      <path d="M12 12c0-5-4-9-9-9 0 5 2 8 5 9h4z" />
      <path d="M12 12c0-5 4-9 9-9 0 5-2 8-5 9h-4z" />
      <path d="M12 12c-3-4-3-9 0-12" />
    </>
  ),
  events: (
    <>
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: "/admin/commerce/gift-cards/generate",
        label: "Gift Cards",
        icon: "gift",
      },
    ],
...
function AdminLayout() {
        ...
        <div className="section__inner admin-auth__inner">
          <Reveal as="div" className="admin-auth__card">
            ...
            <p className="admin-auth__helper">
              Need access? Ask the site owner to enable your account.
            </p>
          </Reveal>
        </div>
      </section>
  ...
  return (
    <AdminDataProvider>
      <div
        className={`adm-shell ${sidebarCollapsed ? "is-sidebar-collapsed" : ""}`}
      >
        {/* ── Sidebar ────────────────────────────────────────────────────────── */}
        <aside
          ...
          <nav className="adm-nav" aria-label="Main navigation">
            {NAV_SECTIONS.map((section) => (
              <div className="adm-nav__section" key={section.id}>
                {section.label && (
                  <span className="adm-nav__section-label" aria-hidden="true">
                    {section.label}
                  </span>
                )}
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <div className="adm-nav__group" key={item.id}>
                      ...
                      <div
                        className={`adm-nav__children ${isOpen ? "is-open" : ""}`}
                        id={groupPanelId}
                      >
                        <div>
                          {(item.children || []).map((child) => (
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                `adm-nav__child ${isActive ? "is-active" : ""}`
                              }
                              onClick={handleNavClick}
        ...
        {/* Backdrop */}
        <button
          className={`adm-backdrop ${drawerOpen ? "is-open" : ""}`}
          type="button"
          aria-label="Close navigation"
        ...
        <nav className="adm-bottom-nav" aria-label="Quick navigation">
          <NavLink
            ...
            className={({ isActive }) =>
              `adm-bottom-nav__btn ${isActive ? "is-active" : ""}`
            }
            onClick={handleNavClick}
          >
          ...
          <button
            className={`adm-bottom-nav__btn ${drawerOpen ? "is-active" : ""}`}
            type="button"
        ...
        <div className="adm-main">
          <header className="adm-header">
            <div className="adm-header__left">
              <button
                className="adm-header__menu-btn"
                type="button"
            ...
            <div className="adm-header__right">
              ...
              <button
                className="adm-header__signout btn btn--secondary"
                type="button"
                onClick={handleSignOut}
              >
                Sign Out
