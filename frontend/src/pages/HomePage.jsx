...
const FALLBACK_PRODUCTS = [
  ...
  },
  {
    ...
    title: "Market Bucket",
    description:
      "Fresh stems in coordinating palettes, ready for styling or gifting.",
    price: "From R600",
    category: "cut-flower",
  ...
  },
  {
    ...
    description:
      "Pressed flower artwork crafted in-studio for thoughtful gifting.",
    price: "On request",
    category: "products",
...
function HomePage() {
  ...
  const liveProducts = remoteProducts.filter(
    (product) => (product.status ?? "live") === "live",
  );
  ...
  const normalizedProducts = liveProducts.map((product, index) => {
    ...
    const primaryCategory =
      rawCategoryValues[0] || product.category || "product";
    ...
    <>
      ...
      <section className="home-hero">
        ...
        <div className="home-hero__text">
          ...
          <p>
            Cut flowers, pressed keepsakes, thoughtful gifts, floral
            arrangements, and hands-on workshops
          </p>
          <div className="cta-group">
            <Link className="btn btn--primary" to="/workshops">
              Book a Workshop
            </Link>
            <Link className="btn btn--ghost" to="/cut-flowers">
              Visit the Farm
            </Link>
          </div>
        </div>
        <div className="home-hero__services">
          <Link className="home-hero__service" to="/cut-flowers">
            <img
              ...
              alt="Buckets of bright cut flowers"
              loading="eager"
              decoding="async"
            />
          ...
          <Link className="home-hero__service" to="/workshops">
            <img
              src={homePhotoOne}
              alt="Pressed flower frame held by hand"
              loading="eager"
              decoding="async"
            />
            <div className="home-hero__service-label">
          ...
          <Link
            ...
            to="/products?category=dahlia-tubers-bethany-blooms-grown"
          >
            <img
              src={dahliaTuberbethanyGrown}
              alt="Pressed floral art and studio products"
              loading="eager"
              decoding="async"
            />
            <div className="home-hero__service-label">
              <span>Bethany Blooms Grown</span>
              <strong>Dahlia Tubers</strong>
            </div>
          </Link>
          <Link className="home-hero__service" to="/events">
            <img
              src={workshopGuestsSmiling}
              alt="Workshop guests at a Bethany Blooms event"
              loading="eager"
              decoding="async"
            />
            <div className="home-hero__service-label">
      ...
      <section className="section section--no-pad band--cream">
        <Reveal as="div" className="editorial-split">
          ...
          <div className="editorial-split__body">
            ...
            <p>
              Visit the flower farm, walk through the rows, and cut your own
              blooms straight from the bush — fresh, seasonal, and entirely your
              own handpicked mix.
            </p>
            <div className="cta-group">
      ...
      <section className="section section--no-pad band--white">
        <Reveal as="div" className="editorial-split editorial-split--reverse">
          ...
          <div className="editorial-split__body">
            ...
            <p>
              Join a guided workshop where you receive a frame and create your
              own floral artwork by placing dried flowers into a design you love
              — a keepsake made entirely by hand.
            </p>
            <div className="cta-group">
      ...
      <section className="section band--cream">
        <div className="section__inner">
          <Reveal as="div" className="editorial-band editorial-band--center">
            ...
            <p>
              From pressed keepsakes to fresh farm cuts, here is a peek at
              recent Bethany Blooms creations.
            </p>
          </Reveal>
        </div>
        <div className="editorial-mosaic">
          {[
            {
              src: homePhotoTwo,
              alt: "Pressed floral art in soft neutral tones",
            },
            {
              src: homePhotoOne,
              alt: "Pressed floral frame with pink blooms held outside",
            },
            {
      ...
      <section className="section band--white" id="product-collection">
        <div className="section__inner">
          <Reveal as="div" className="editorial-band editorial-band--center">
            ...
            <p>
              Curated pieces crafted for gifting, styling, and preserving your
              favourite floral moments. Browse a blend of ready-to-enjoy
              arrangements, pressed art keepsakes, and bespoke kits.
            </p>
          </Reveal>
          ...
          {productsStatus === "loading" && (
            <p className="empty-state">Loading featured products...</p>
          )}
